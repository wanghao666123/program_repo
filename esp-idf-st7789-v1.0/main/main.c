...
static void listLittleFFS(char * path) {
...
esp_err_t mountLittleFFS(char * path, char * label) {
...
void app_main(void)
{
	...
	ESP_ERROR_CHECK(mountLittleFFS("/fonts", "part_fonts"));
	listLittleFFS("/fonts/");

	ESP_ERROR_CHECK(mountLittleFFS("/images", "part_images"));
	listLittleFFS("/images/");

	ESP_ERROR_CHECK(mountLittleFFS("/icons", "part_icons"));
	listLittleFFS("/icons/");
